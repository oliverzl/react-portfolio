...
const Contact = (props) => {
	...
	const [contactAnimationPlaying, setContactAnimationPlaying] = useState(true);
	...
	return (
		<div className="main-bg" ref={props.refProp}>
			{contactAnimationPlaying ? (
				<div>
					<svg className="word-svg headerSVGShadow" height="70px">
						<path
							className="svg-path"
					...
					<Typist className="typist-mini" cursor={{ show: false }} avgTypingDelay={20}>
						<Typist.Delay ms={400} />
						<h4 className="typist-mini-text">Let's discuss your next project!</h4>
					</Typist>
				</div>
			) : (
				""
